      ...
      <div className="hero-section">
        <div className="hero-content">
          ...
          <div className="social-icons">
            ...
            <a href="https://x.com/tomiwahimself" target="_blank" rel="noopener noreferrer" className="social-icon" title="Twitter">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
              </svg>
            </a>
            <a href="https://www.linkedin.com/public-profile/settings/?trk=d_flagship3_profile_self_view_public_profile&lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base%3BcM1my6vLQqCYAKpI4%2FgxAA%3D%3D" target="_blank" rel="noopener noreferrer" className="social-icon" title="LinkedIn">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
    ...
    <div className="page about-page">
      ...
      <div className="about-content">
        <div className="about-image">
          <div className="profile-pic animate-in stagger-1"><img src="/Adetomiwa.PNG" alt="Profile" /></div>
        </div>

        <div className="about-text">
          <h2 className="animate-in stagger-2">Hello! I'm ADEDINSEWO ADETOMIWA</h2>
      ...
      <div className="cv-download-section">
        <h2 style={{ fontSize: '2rem', marginBottom: '1rem', color: '#667eea' }}>Download CV</h2>
  ...
  return (
    <footer className="footer">
      ...
      <div className="footer-bottom">
        <p>© 2026 Tommy Dev. All rights reserved.</p>
      </div>
    </footer>
  );
}