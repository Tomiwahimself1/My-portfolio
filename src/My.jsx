      ...
      <div className="hero-section">
        <div className="hero-content">
          ...
          <div className="social-icons">
            <a href="www.linkedin.com/in/adetomiwa-adedinsewo-717605271" target="_blank" rel="noopener noreferrer" className="social-icon" title="GitHub">
            ...
            <a href="www.linkedin.com/in/adetomiwa-adedinsewo-717605271" target="_blank" rel="noopener noreferrer" className="social-icon" title="LinkedIn">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
