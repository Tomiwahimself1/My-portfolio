...
export default function EcommercePlatform() {
  ...
  className="w-full pl-10 pr-4 py-3 border border-gray-700 bg-gray-800 text-white placeholder-gray-400 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none"
/>
